...
data = pd.read_csv('../data/input/modified/DOE School Calendar Dates_edited_2023-2024.csv').drop(columns = ['Unnamed: 3'])
data = data.replace('–', '-') 
```
...
enrollment_count = {
    ...
    2021: 1058888,
    2022: 1047895,
    2023: 1047895*0.989 #This is an based on the 1.0% drop in school population from last year. Per info provided by DOE
...
#data_orig.to_csv('/Users/nycc/Desktop/data_orig_updated_oct_2023.csv')
```
